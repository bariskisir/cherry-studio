...
const AboutSettings: FC = () => {
  ...
  const showReleases = async () => {
    onOpenWebsite('https://github.com/bariskisir/cherry-studio/releases')
  }
      ...
      <SettingGroup theme={theme}>
        <SettingTitle>
          ...
          <HStack alignItems="center">
            <Link to="https://github.com/bariskisir/cherry-studio">
        ...
        <AboutHeader>
          <Row align="middle">
            <AvatarWrapper onClick={() => onOpenWebsite('https://github.com/bariskisir/cherry-studio')}>
            ...
            <VersionWrapper>
              ...
              <Tag
                onClick={() => onOpenWebsite('https://github.com/bariskisir/cherry-studio/releases')}
                color="cyan"
