...
import { APP_NAME, FeedUrl, UpgradeChannel } from '@shared/config/constant'
...
export default class AppUpdater {
  ...
  constructor() {
    ...
    // github doesn't support multiple range download
  ...
  private async _setFeedUrl() {
    ...
    logger.info(
      `Setting feed URL for version ${app.getVersion()}, testPlan: ${testPlan}, requested channel: ${requestedChannel}`
    )

    this._setChannel(requestedChannel, FeedUrl.GITHUB_LATEST)
  }
