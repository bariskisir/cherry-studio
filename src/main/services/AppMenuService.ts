      ...
      },
      {
        ...
        submenu: [
          ...
          },
          {
            ...
            click: () => {
              void shell.openExternal('https://github.com/bariskisir/cherry-studio/issues/new/choose')
            }
          },
          {
            label: appMenu.releases,
            click: () => {
              void shell.openExternal('https://github.com/bariskisir/cherry-studio/releases')
            }
          }
        ]
      }
